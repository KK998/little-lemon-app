        ...
        <section className='w-full flex flex-col items-center justify-center py-32'>
            <Container className='flex justify-between'>
                <div className='flex flex-col w-[360px]'>
                    <Typography tag="h4" type='Display title' className={colors.text.primary.yellow}>
                        Little Lemon
                    </Typography>
                    <Typography tag="h5" type='Sub title' className={cn(colors.text.secondary.black, "mb-4")}>
                        Chicago
                    </Typography>
                    <Typography tag="p" type='Lead text' className={cn(colors.text.secondary.black, "text-justify")}>
                ...
                <div className='flex flex-col items-end flex-grow relative sm:h-[494px] max-w-full'>
