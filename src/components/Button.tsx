...
const ButtonVariants = cva("h-[50px] py-4 px-20 rounded-2xl max-w-full flex items-center justify-center gap-5 transition-shadow hover:shadow-xl whitespace-nowrap", {
    variants: {
        kind: {
